...
function setMessage(msg_content, title, content_type, extras) {
    ...
    if (title != null) {
        if (typeof title !== 'string') {
            throw new JError.InvalidArgumentError("Invalid socket.title, it can only be set to the String");
        }
        message['title'] = title;
    }
    ...
    if (content_type != null) {
        if (typeof content_type !== 'string') {
            throw new JError.InvalidArgumentError("Invalid socket.content_type, it can only be set to the String");
        }
    ...
    if (extras != null) {
        if (typeof extras != 'object') {
            throw new JError.InvalidArgumentError("Invalid socket.extras");
        }
...
function validate(payload) {
    ...
    if (!notification && !message) {
        throw new JError.InvalidArgumentError('Either or both notification and socket must be set.');
    }
}
