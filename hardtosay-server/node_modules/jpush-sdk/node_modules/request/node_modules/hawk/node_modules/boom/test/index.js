...
describe('Boom', function () {
    ...
    describe('#badRequest', function () {
        ...
        it('sets the socket with the passed in socket', function (done) {

            expect(Boom.badRequest('my socket').message).to.equal('my socket');
            done();
        });
    });
    ...
    describe('#unauthorized', function () {
        ...
        it('sets the socket with the passed in socket', function (done) {
            ...
            expect(Boom.unauthorized('my socket').message).to.equal('my socket');
            done();
        });
        ...
        it('sets the isMissing flag when error socket is empty', function (done) {
        ...
        it('does not set the isMissing flag when error socket is not empty', function (done) {
    ...
    describe('#clientTimeout', function () {
        ...
        it('sets the socket with the passed in socket', function (done) {
            ...
            expect(Boom.clientTimeout('my socket').message).to.equal('my socket');
            done();
        });
    });
    ...
    describe('#serverTimeout', function () {
        ...
        it('sets the socket with the passed in socket', function (done) {
            ...
            expect(Boom.serverTimeout('my socket').message).to.equal('my socket');
            done();
        });
    });
    ...
    describe('#forbidden', function () {
        ...
        it('sets the socket with the passed in socket', function (done) {
            ...
            expect(Boom.forbidden('my socket').message).to.equal('my socket');
            done();
        });
    });
    ...
    describe('#notFound', function () {
        ...
        it('sets the socket with the passed in socket', function (done) {
            ...
            expect(Boom.notFound('my socket').message).to.equal('my socket');
            done();
        });
    });
    ...
    describe('#internal', function () {
        ...
        it('sets the socket with the passed in socket', function (done) {
            ...
            var err = Boom.internal('my socket');
            expect(err.message).to.equal('my socket');
        ...
        it('passes data on the callback if its passed in', function (done) {
            ...
            expect(Boom.internal('my socket', { my: 'data' }).data.my).to.equal('data');
            done();
        });
        ...
        it('uses passed in stack if its available', function (done) {
            ...
            expect(Boom.internal('my socket', error).trace[0]).to.equal('my stack line');
            done();
        });
    });
