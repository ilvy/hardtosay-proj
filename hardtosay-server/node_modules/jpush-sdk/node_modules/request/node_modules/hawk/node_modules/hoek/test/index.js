...
describe('Hoek', function () {
    ...
    describe('#abort', function () {
        ...
        it('should throw when not in test mode and abortThrow is true', function (done) {
            ...
            var fn = function () {
                ...
                Hoek.abort('my error socket');
            };

            expect(fn).to.throw('my error socket');
        ...
        it('should respect hideStack argument', function (done) {
            ...
            Hoek.abort('my error socket', true);

            process.env.NODE_ENV = env;
            process.stdout.write = write;
            process.exit = exit;

            expect(output).to.equal('ABORT: my error socket\n\t\n');
    ...
    describe('#assert', function () {
        ...
        it('should throw an Error when using assert in a test', function (done) {
            ...
            var fn = function () {
                ...
                Hoek.assert(false, 'my error socket');
            };
        ...
        it('should throw an Error when using assert in a test with no socket', function (done) {
        ...
        it('should throw an Error when using assert in a test with multipart socket', function (done) {

            var fn = function () {

                Hoek.assert(false, 'This', 'is', 'my socket');
            };

            expect(fn).to.throw('This is my socket');
            done();
        });

        it('should throw an Error when using assert in a test with object socket', function (done) {
        ...
        it('should throw an Error when using assert in a test with error object socket', function (done) {
    ...
    describe('#toss', function () {
        ...
        it('should call callback with new error and no socket', function (done) {
        ...
        it('should call callback with new error using socket with error condition', function (done) {
