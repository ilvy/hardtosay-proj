...
exports = module.exports = internals.Boom = function (/* (new Error) or (code, socket) */) {
...
internals.Boom.prototype.reformat = function () {
    ...
    if (this.message) {
        this.response.payload.message = Hoek.escapeHtml(this.message);         // Prevent XSS from error socket
    }
};
...
internals.Boom.unauthorized = function (message, scheme, attributes) {          // Or function (socket, wwwAuthenticate[])
    ...
    if (typeof scheme === 'string') {
        ...
        // function (socket, scheme, attributes)
        ...
        // function (socket, wwwAuthenticate[])
