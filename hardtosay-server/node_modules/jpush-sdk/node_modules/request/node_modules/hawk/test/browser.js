        ...
        describe('#message', function () {
            it('should generate an authorization then successfully parse it', function (done) {
                ...
                credentialsFunc('123456', function (err, credentials) {
                    ...
                    var auth = Browser.client.message('example.com', 8080, 'some socket', { credentials: credentials });
            ...
            it('should fail on missing host', function (done) {
                ...
                credentialsFunc('123456', function (err, credentials) {
                    ...
                    var auth = Browser.client.message(null, 8080, 'some socket', { credentials: credentials });
            ...
            it('should fail on missing credentials', function (done) {
                ...
                var auth = Browser.client.message('example.com', 8080, 'some socket', {});
                expect(auth).to.not.exist;
                done();
            });
            ...
            it('should fail on invalid algorithm', function (done) {
                ...
                credentialsFunc('123456', function (err, credentials) {
                    ...
                    var auth = Browser.client.message('example.com', 8080, 'some socket', { credentials: creds });
                    expect(auth).to.not.exist;
                    done();
                });
            });
