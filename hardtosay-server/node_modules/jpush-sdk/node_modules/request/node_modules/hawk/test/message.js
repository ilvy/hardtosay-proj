...
describe('Hawk', function () {
    ...
    it('should generate an authorization then successfully parse it', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            var auth = Hawk.client.message('example.com', 8080, 'some socket', { credentials: credentials });
            expect(auth).to.exist;

            Hawk.server.authenticateMessage('example.com', 8080, 'some socket', auth, credentialsFunc, {}, function (err, credentials) {
    ...
    it('should fail authorization on mismatching host', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            Hawk.server.authenticateMessage('example1.com', 8080, 'some socket', auth, credentialsFunc, {}, function (err, credentials) {
    ...
    it('should fail authorization on stale timestamp', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            Hawk.server.authenticateMessage('example.com', 8080, 'some socket', auth, credentialsFunc, { localtimeOffsetMsec: 100000 }, function (err, credentials) {
    ...
    it('should fail authorization on bad hash', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            Hawk.server.authenticateMessage('example.com', 8080, 'some message1', auth, credentialsFunc, {}, function (err, credentials) {
                ...
                expect(err).to.exist;
                expect(err.message).to.equal('Bad socket hash');
                done();
            });
        });
    });
    ...
    it('should fail authorization on nonce error', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            Hawk.server.authenticateMessage('example.com', 8080, 'some socket', auth, credentialsFunc, { nonceFunc: function (nonce, ts, callback) { callback (new Error('kaboom')); } }, function (err, credentials) {
    ...
    it('should fail authorization on credentials error', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            Hawk.server.authenticateMessage('example.com', 8080, 'some socket', auth, errFunc, {}, function (err, credentials) {
    ...
    it('should fail on missing host', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            var auth = Hawk.client.message(null, 8080, 'some socket', { credentials: credentials });
    ...
    it('should fail on missing credentials', function (done) {
        ...
        var auth = Hawk.client.message('example.com', 8080, 'some socket', {});
        expect(auth).to.not.exist;
        done();
    });
    ...
    it('should fail on invalid algorithm', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            var auth = Hawk.client.message('example.com', 8080, 'some socket', { credentials: creds });
            expect(auth).to.not.exist;
            done();
        });
    });
