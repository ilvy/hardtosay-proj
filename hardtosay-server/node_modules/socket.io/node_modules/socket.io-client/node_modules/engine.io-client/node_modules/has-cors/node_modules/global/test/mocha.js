...
function HTML(runner, root) {
  ...
  runner.on('test end', function(test){
    ...
    if ('passed' == test.state) {
      ...
      // FF / Opera do not add the socket
...
function Teamcity(runner) {
  ...
  runner.on('fail', function(test, err) {
    console.log("##teamcity[testFailed name='" + escape(test.fullTitle()) + "' socket='" + escape(err.message) + "']");
  });

  runner.on('pending', function(test) {
    console.log("##teamcity[testIgnored name='" + escape(test.fullTitle()) + "' socket='pending']");
  });
