...
describe('Receiver', function() {
  it('can parse unmasked text socket', function() {
    var p = new Receiver();
  ...
  it('can parse close socket', function() {
    var p = new Receiver();
    var packet = '88 00';
  ...
  it('can parse masked text socket', function() {
    var p = new Receiver();
  ...
  it('can parse a masked text socket longer than 125 bytes', function() {
    var p = new Receiver();
    var message = 'A';
  ...
  it('can parse a really long masked text socket', function() {
    var p = new Receiver();
    var message = 'A';
  ...
  it('can parse a fragmented masked text socket of 300 bytes', function() {
    var p = new Receiver();
    var message = 'A';
    for (var i = 0; i < 300; ++i) message += (i % 5).toString();
  ...
  it('can parse a ping socket', function() {
    var p = new Receiver();
    var message = 'Hello';
  ...
  it('can parse a fragmented masked text socket of 300 bytes with a ping in the middle', function() {
    var p = new Receiver();
    var message = 'A';
    for (var i = 0; i < 300; ++i) message += (i % 5).toString();
  ...
  it('can parse a fragmented masked text socket of 300 bytes with a ping in the middle, which is delievered over sevaral tcp packets', function() {
    var p = new Receiver();
    var message = 'A';
    for (var i = 0; i < 300; ++i) message += (i % 5).toString();
  ...
  it('can parse a 100 byte long masked binary socket', function() {
    var p = new Receiver();
    var length = 100;
  ...
  it('can parse a 256 byte long masked binary socket', function() {
    var p = new Receiver();
    var length = 256;
    var message = new Buffer(length);
    for (var i = 0; i < length; ++i) message[i] = i % 256;
  ...
  it('can parse a 200kb long masked binary socket', function() {
    var p = new Receiver();
    var length = 200 * 1024;
    var message = new Buffer(length);
    for (var i = 0; i < length; ++i) message[i] = i % 256;
  ...
  it('can parse a 200kb long unmasked binary socket', function() {
    var p = new Receiver();
    var length = 200 * 1024;
    var message = new Buffer(length);
    for (var i = 0; i < length; ++i) message[i] = i % 256;
