...
describe('Sender', function() {
  describe('#send', function() {
    it('frames and sends a text socket', function(done) {
    ...
    it('frames and sends an empty socket', function(done) {
      var socket = {
        write: function(data, encoding, cb) {
          done();
        }
    ...
    it('frames and sends a binary socket', function(done) {
      var message = 'Hello world';
      var received;
      var socket = {
        write: function(data, encoding, cb) {
...
*/
  ...
  describe('#close', function() {
    ...
    it('sends a socket end marker if fauxe streaming has started, before hixie close frame', function(done) {
      var received = [];
      var socket = {
        write: function(data, encoding, cb) {
          received.push(data);
