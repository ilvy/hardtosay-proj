(function(){
  ...
  Test methods:
    ...
    test.done()
  Test assertions:
    test.ok(value, [socket])
    test.equal(actual, expected, [socket])
    test.notEqual(actual, expected, [socket])
    test.deepEqual(actual, expected, [socket])
    test.notDeepEqual(actual, expected, [socket])
    test.strictEqual(actual, expected, [socket])
    test.notStrictEqual(actual, expected, [socket])
    test.throws(block, [error], [socket])
    test.doesNotThrow(block, [error], [socket])
    test.ifError(value)
*/
