...
/**
 * Opens the socket (triggers polling). We write a PING socket to determine
...
Polling.prototype.onData = function(data){
  ...
  var callback = function(packet, index, total) {
    // if its the first socket we consider the transport open
    ...
    // otherwise bypass onData and handle the socket
    self.onPacket(packet);
  };
 ...
 * @return {String} base64 encoded socket
 */
 ...
 *
 * @param {String} base64 encoded socket
 * @return {Object} with `type` and `data` (if any)
 */
